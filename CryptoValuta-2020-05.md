...
**Безналичный** вид владения представлением взаимоотношения - когда сторона участвующая в данном взаимоотношении поручает хранение и распоряжение по своим поручениям представлением взаимоотношения третьей стороне. Например, безналичные рубли - ими распоряжается банк, по вашим поручениям. Так же и с документарной и бездокументарной формами ценных бумаг - это суть наличная и безналичная формы.
...
Предлагаю не только предлагаемые здесь поправки, но и все законы переписать отталкиваясь от этого принципа. Это упростит законы и уменьшит нагрузку на всю экономику страны снизив затраты на юристов, адвокатов, налоговиков, силовиков и суды. Закон написанный не по этому принципу - низкокачественный закон.
...
**Заменить на:**
**п. 2. Цифровыми финансовыми активами признаются цифровые права, обязанность по которым имеет все признаки эмиссионной ценной бумаги, определение которой дано в подпункт 1 пункта 1 статьи 2 39-ФЗ "О рынке ценных бумаг".**

**Пояснения.**
Понятие "цифровые права" уже дано в ГК ст. 141. Это обобщающее понятие. Далее идет уточняющие признаки для цифрового вида представления этих прав, которые уже есть в существующем законодательстве как суть эмиссионной ценной бумаги.

**Дополнение.**
Представляется более рациональным дополнение именно понятий в уже существующих законах, а не создание нового отдельного закона, который дублирует по сути существующие. Так уже есть закон регулирующие оборот эмиссионных ценных бумаг, можно сделать правки в него:
...
п.3 - исключить, он становится не нужен, так как мы во 2-м пункте уже определили суть цифровых активов как ценных бумаг в цифровом виде. А если цифровое право имеет другую суть взаимоотношения, то это взаимоотношение регулируется другим нормами и законами - но не тут.

Так же представляется рациональным добавить в ГК статью об видах представления взаимоотношений и договоров, где будет для всех законов определен список этих видов так, чтобы не было необходимости в каждом законе описывать эти виды:  
+ Письменный вид (непосредственный - бумажный, электронный, цифровой)
+ Устный вид (непосредственный - голосовой, механический, электронный)
...
**Исключить**
Так как он полностью продублирован в законе "О цифровой валюте", см. ниже. А определение "цифровые операционные знаки" полностью совпадает с определением "Цифровая Валюта", в связи с чем создается двузначность трактования законов.
...
----------------
**Исключить**
Если сущность содержит признаки цифрового актива, то уже без разницы что она еще содержит - она и так будет регулироваться этим законом, и в дополнение получит еще ограничения от другого закона - это должна быть общая практика применения ограничений из разных законов.
...
Далее по ходу текста закона все требования к информационной системе и ее операторам перенести в 149-ФЗ «Об информации, информационных технологиях и о защите информации» и упорядочить их там. И сделать отсылку к нему в статье 2 - где даются определения цифровым активам.
